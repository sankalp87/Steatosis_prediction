In this folder you can find a KNIME workflow for executing ML models with Stratified bagging as a meta-classifier and iterative descriptor combination.
